        ...
        with cmp_tab:
            ...
            if not stock_b or stock_b == "—":
                ...
                if analysis:
                    ...
                    section_sources = analysis.get("section_sources") or {}
                    ...
                    st.caption(f"Source: {section_sources.get('trend_summary', 'unknown')}")
                    st.write(analysis.get("trend_summary", "N/A"))

                    st.markdown("**Anomaly Report**")
                    st.caption(f"Source: {section_sources.get('anomaly_report', 'unknown')}")
                    st.write(analysis.get("anomaly_report", "N/A"))

                    st.markdown("**Risk Commentary**")
                    st.caption(f"Source: {section_sources.get('risk_commentary', 'unknown')}")
                    st.write(analysis.get("risk_commentary", "N/A"))

                    st.markdown("**Comparison**")
                    st.caption(f"Source: {section_sources.get('comparison', 'unknown')}")
                    st.write(analysis.get("comparison", "N/A"))
